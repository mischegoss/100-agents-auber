...
description: >-
  This document details the available system integration endpoints for client
  applications to interact with backend services, including data retrieval and
  modification.
tags:
  - API
  - endpoints
...
enhanced_at: '2025-06-27T22:07:32.949Z'
